...
The reference section focuses on public contracts most plugin authors use:

- [Plugin API](/docs/reference/plugin-api) — `Plugin`, `AudioKernel`, contexts, parameters, and UI descriptors.
